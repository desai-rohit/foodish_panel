...
List<OrderModelCopy> orderModelcopyFromJson(String str) =>
    List<OrderModelCopy>.from(json.decode(str).map((x) => OrderModelCopy.fromJson(x)));

String orderModelcopyToJson(List<OrderModelCopy> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class OrderModelCopy {
  String id;
  String productsId;
  String username;
  String useremail;
  ...
  factory OrderModelCopy.fromJson(Map<String, dynamic> json) => OrderModelCopy(
      id: json["_id"],
